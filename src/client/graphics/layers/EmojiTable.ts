...
export class EmojiTable extends LitElement {
  ...
  render() {
    ...
    return html`
      <div
        class="fixed inset-0 bg-black/15 backdrop-brightness-110 flex items-center justify-center z-[11002]"
        @click=${this.handleBackdropClick}
      >
        <div
          class="bg-zinc-900/95 p-[6px] flex items-center justify-center rounded-[10px] z-[11003] relative shadow-2xl shadow-black/50 ring-1 ring-white/5"
          style="
        ...
        >
          ...
          <button
            class="absolute -top-3 -right-3 w-7 h-7 flex items-center justify-center
                      bg-zinc-700 hover:bg-red-500 text-white rounded-full shadow transition-colors z-[11004]"
